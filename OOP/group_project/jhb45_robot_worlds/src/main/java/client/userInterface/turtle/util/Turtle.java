...
package client.userInterface.turtle.util;
 ...
 */
   ...
   /**
    ...
    //     synchronized (turtleLock) {
    //         // Ensure the turtle is selected
    //         Turtle.selectedTurtle = this;
    
    //         // Save the current graphics state
    //         Graphics2D g = (Graphics2D) onscreen.create();
    //         g.setFont(new Font("Arial", Font.PLAIN, 12)); // Customize the font as needed
    ...
    //         offscreen.drawImage(onscreenImage,x, y, null);
    //         // offscreen.drawImage(onscreenImage,(int) posX, (int)posY, null);
