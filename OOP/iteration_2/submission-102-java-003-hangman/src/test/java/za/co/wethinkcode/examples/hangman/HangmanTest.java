...
class HangmanTest {
    ...
    private void simulateGame(String simulatedUserInput, String expectedLastLine) {                     //<1>
        ...
        System.setOut(new PrintStream(outputStreamCaptor));// captures output stream so that nothing is printed out.                                      //<5>

        try {                                                                                           //<6>
            Hangman.main(new String[]{});                                                               //<7>
        } catch (IOException e) {                                                                       //<8>
            fail("Not expecting an exception."); //force test to fail                                                        //<9>
        }
